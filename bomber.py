...
def bann_text():
   ...
   [=======================================]
   [                                       ]
   [      Desing By: Chanadan Lahre        ]
   [    Vii-Kamroud , Dist-Dhamtari (CG)   ] 
   [  My Website www.Cgtech2ins.epizy.com  ]
   [                                       ]
   [=======================================]
   [=======================================]
...
def check_for_updates():
    ...
    if fver != __VERSION__:
        ...
        mesgdcrt.SuccessMessage("CGTech2ins is up-to-date")
        mesgdcrt.GeneralMessage("Starting CGTech2ins")
...
def pretty_print(cc, target, success, failed):
    ...
    mesgdcrt.SuccessMessage("CGTech2ins was created by SpeedX")
...
if sys.version_info[0] != 3:
    mesgdcrt.FailureMessage("CGTech2ins will work only in Python v3")
    sys.exit()
...
description = ("CGTech2ins - Your Friendly Spammer Application\n"
               "\n"
